...
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: JXOlOVxN4bvZ/css
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: MBijgIAfFkxK/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: 2eBYD6HB9msR/icon
...
function PlasmicPageLayout__RenderFunc(props) {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__rtzQh)}
          role={"img"}
        />
      }
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <DataCtxReader__>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox__x7C1V)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg___3OkCs)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <DataCtxReader__>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox__lAkXz)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section__pLhxv)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,
